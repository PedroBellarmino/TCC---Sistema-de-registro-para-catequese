...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT * FROM turma WHERE nome_tur LIKE '%$termoPesquisa%' OR horario_tur LIKE '%$termoPesquisa%' OR faixa_tur LIKE '%$termoPesquisa%'";
} else {
...
?>
    ...
    <div id="tabela">
        <h5>Total de turmas no sistema: <?php echo mysqli_num_rows($res); ?></h5>
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                while ($linha = mysqli_fetch_array($res)) {
                    ...
                    <td ><a class="btn border btn-danger" href="excluir_turma.php?id_tur=<?php echo $linha['id_tur']; ?>">Desativar</a></td>
                    <td ><a class="btn border btn-success" href="reativar_turma.php?id_tur=<?php echo $linha['id_tur']; ?>">Reativar</a></td>
                    <td ><a class="btn border" href="edita_turma.php?id_tur=<?php echo $linha['id_tur']; ?>">Alterar</a></td>
                </tr>
                    </tr>
                <?php } ?>
            </tbody>
