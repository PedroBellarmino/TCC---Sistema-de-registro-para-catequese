...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <form class="form-inline my-2 my-lg-0" method="post">
            <input class="form-control mr-sm-2" type="search" placeholder="Pesquisar por Usuario" aria-label="Search" name="termo_pesquisa">
        </form>
    </nav>
            ...
            <tbody>
                ...
                while ($linha = mysqli_fetch_array($res)) {
                    ...
                    <tr>
                        ...
                        <td ><a class="btn border btn-danger" href="excluir_usuario.php?id_usu=<?php echo $linha['id_usu']; ?>">Excluir</a></td>
                    <td ><a class="btn border" href="edita_usuario.php?id_usu=<?php echo $linha['id_usu']; ?>">Alterar</a></td>
                        </td>
                </tr>
                    </tr>
                <?php } ?>
