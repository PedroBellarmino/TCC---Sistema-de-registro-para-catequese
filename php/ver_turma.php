...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT * FROM aluno WHERE nome_alu LIKE '%$termoPesquisa%' OR sexo_alu LIKE '%$termoPesquisa%'";

     $res = mysqli_query($mysqli, $sql);
    } else {
        $pk = $_GET['id_tur'];
        $sql = "SELECT * FROM aluno WHERE turma_id='$pk' AND status_alu='ativo'";
...
?>
    ...
    <div id="tabela">
        <h5>Total de alunos na turma: <?php echo mysqli_num_rows($res); ?></h5>
